...
<!-- TOC START -->
## Table of Contents
- [🗄️ iOS Database Migration Framework](#-ios-database-migration-framework)
...
- [⚡ Performance](#-performance)
  - [Large Dataset Migration](#large-dataset-migration)
  - [Background Migration](#background-migration)
